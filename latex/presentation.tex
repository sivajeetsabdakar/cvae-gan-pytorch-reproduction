...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{column}{0.43\textwidth}
    ...
    \textbf{Verified smoke run:} training and sampling passed.\par
    \textbf{Expected full-run target:} Top-1 $\approx$97.78\%, realism $\approx$19.03.\par
    \textbf{Actual full-run metrics:} \pending.\par}
