...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.57\textwidth}
    ...
    \begin{itemize}\setlength\itemsep{0.28em}
      ...
      \item \textbf{Project code:} \href{\RepoURL}{\textcolor{Cyan}{\RepoURL}} \quad \pending
    \end{itemize}
  \end{column}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{column}{0.52\textwidth}
    ...
    \begin{itemize}\setlength\itemsep{0.28em}
      ...
      \item \textbf{Workspace status:} no source code, checkpoints, or logs were present in \texttt{LAB03}. Framework changes and executed settings are therefore \pending.
    \end{itemize}
  \end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{column}{0.43\textwidth}
    ...
    \textbf{Reproduced metrics:} \pending\par
    \textbf{Difference:} not computable without a run.\par}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.56\textwidth}
    ...
    \begin{itemize}\setlength\itemsep{0.27em}
      \item \textbf{Reproduction status:} the paper analysis and presentation are complete; model reproduction remains \pending because the workspace contains no implementation or run artifacts.
